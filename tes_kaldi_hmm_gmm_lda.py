...
asr = GmmLatticeFasterRecognizer.from_files(
    # tugas_akhir_2
    "model/tugas_akhir_2/exp/hmm-gmm/tri-sat/final.mdl",
    "model/tugas_akhir_2/exp/hmm-gmm/tri-sat/graph/HCLG.fst",
    "model/tugas_akhir_2/exp/hmm-gmm/tri-sat/graph/words.txt",

    # # tugas_akhir_win
    # "model/tugas_akhir_win/exp/hmm-gmm/tri-sat/final.mdl",
    # "model/tugas_akhir_win/exp/hmm-gmm/tri-sat/graph/HCLG.fst",
    # "model/tugas_akhir_win/exp/hmm-gmm/tri-sat/graph/words.txt",
...
feats_rspecifier = (
    ...
    # tugas_akhir_2
    " | kaldi/src/featbin/transform-feats model/tugas_akhir_2/exp/hmm-gmm/tri-sat/final.mat ark:- ark:- |"
    # # tugas_akhir_win
    # " | kaldi/src/featbin/transform-feats model/tugas_akhir_win/exp/hmm-gmm/tri-sat/final.mat ark:- ark:- |"
    )
